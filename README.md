...
## Como Jogar
O objetivo do jogo BluffyCastle é [inserir aqui uma breve descrição do objetivo do jogo].

Para executar o jogo, siga as instruções abaixo:

[Inserir aqui as instruções de como baixar ou compilar o jogo, se aplicável].

[Inserir aqui as instruções de como iniciar o jogo].

[Inserir aqui as instruções de como jogar, incluindo controles e mecânicas principais].
...
## Créditos
O desenvolvimento do BluffyCastle foi realizado por [Seu Nome] e [Nome do Coautor] como parte do trabalho do terceiro semestre da faculdade FATEC - São Caetano - Antônio Russo.
